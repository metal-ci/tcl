///////////////////////////////////////////////////////////////////////////////
// copied from boost.multiprecision  & adapted for tcl
...
#ifndef METAL_TCL_BUILTIN_BIGNUM_HPP
#define METAL_TCL_BUILTIN_BIGNUM_HPP
...
inline void check_tommath_result(ErrType v)
{
   if (BOOST_UNLIKELY(v != MP_OKAY))
   {
      ...
      switch (v)
      {
          switch (v)
          {
              case MP_OKAY: msg =  "no error"; break;
              case MP_ERR:  msg =  "unknown error"; break;
              case MP_MEM:  msg =  "out of mem"; break;
              case MP_VAL:  msg =  "invalid input"; break;
              case MP_ITER: msg =  "maximum iterations reached"; break;
              case MP_BUF:  msg =  "buffer overflow, supplied buffer too small"; break;
              default:      msg =  "Unknown error";
          }
      }
      BOOST_MP_THROW_EXCEPTION(std::runtime_error(msg));
   }
}
...
struct tommath_int
{
   ...
   // Pick off 64 bit chunks for mp_set_u64:
   tommath_int& operator=(boost::uint128_type i)
   {
      if (m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));

     boost::int128_type  mask  = ((static_cast<boost::uint128_type>(1u) << 64) - 1);
      unsigned           shift = 0;
      ::mp_int           t;
      detail::check_tommath_result(mp_init(&t));
      mp_zero(&m_data);
   ...
   tommath_int& operator=(boost::int128_type i)
   {
      if (m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
      bool neg = i < 0;
   ...
   tommath_int& assign_float(F a)
   {
      ...
      while (f)
      {
         ...
         if (term > 0)
         {
            mp_set_ull(&t, static_cast<part_type>(term));
            detail::check_tommath_result(mp_add(&m_data, &t, &m_data));
         }
         else
         {
            mp_set_ll(&t, static_cast<part_type>(-term));
   ...
   tommath_int& operator= (boost::float128_type a)
   {
      return assign_float(a);
   }
#endif
...
inline void eval_convert_to(unsigned long long* res, const tommath_int& cb)
{
    auto sz = mp_unsigned_bin_size(&cb.data());
    if (sz > sizeof(std::uintmax_t))
        *res = std::numeric_limits<std::uintmax_t>::max();
    else
    {
        detail::check_tommath_result(mp_to_unsigned_bin(&cb.data(), reinterpret_cast<unsigned char*>(&res)));
...
#ifdef BOOST_HAS_INT128
inline void eval_convert_to(boost::uint128_type* result, const tommath_int& val)
{
#ifdef MP_DEPRECATED
   if (mp_ubin_size(&val.data()) > sizeof(boost::uint128_type))
   {
      *result = ~static_cast<boost::uint128_type>(0);
      return;
   }
   unsigned char buf[sizeof(boost::uint128_type)];
   std::size_t   len;
...
inline void eval_convert_to(boost::int128_type* result, const tommath_int& val)
{
  boost::uint128_type r;
   eval_convert_to(&r, val);
   if (mp_isneg(&val.data()))
      *result = -static_cast<boost::int128_type>(r);
   else
      *result = r;
}
#endif
#if defined(BOOST_HAS_FLOAT128)
inline void eval_convert_to(boost::float128_type* result, const tommath_int& val) noexcept
{
   *result = boost::multiprecision::float128_procs::strtoflt128(val.str(0, std::ios_base::scientific).c_str(), nullptr);
}
#endif
...
inline typename std::enable_if<boost::multiprecision::detail::is_unsigned<Integer>::value, Integer>::type eval_integer_modulus(const tommath_int& x, Integer val)
{
   ...
   {
      return multiprecision::default_ops::eval_integer_modulus(x, val);
   }
}*/
...
using bignum = boost::multiprecision::number<tommath_int>          ;
...
{
    template <>
    struct number_category<metal::tcl::tommath_int> : public std::integral_constant<int, boost::multiprecision::number_kind_integer>
    {};
...
class numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >
{
   using number_type = boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates>;
...
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::digits;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::digits10;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::max_digits10;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_signed;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_integer;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_exact;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::radix;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::min_exponent;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::min_exponent10;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::max_exponent;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::max_exponent10;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::has_infinity;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::has_quiet_NaN;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::has_signaling_NaN;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::has_denorm;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::has_denorm_loss;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_iec559;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_bounded;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::is_modulo;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::traps;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::tinyness_before;
template <boost::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<boost::multiprecision::number<metal::tcl::tommath_int, ExpressionTemplates> >::round_style;
...
inline std::optional<bignum>  tag_invoke(
        cast_tag<bignum>,
        Tcl_Interp * interp,
        boost::intrusive_ptr<Tcl_Obj> val)
{
    using tag = cast_tag<bignum>;
    tommath_int res;
    if (Tcl_GetBignumFromObj(interp, val.get(), &res.data()) == TCL_OK)
        return bignum(res);
    else
        return std::nullopt;
}
...
inline object_ptr tag_invoke(
        ...
        bignum nm)
{
    return Tcl_NewBignumObj(&nm.backend().data());
}

inline bool tag_invoke(
        const equal_type_tag<bignum> & tag,
        const Tcl_ObjType & type)
{
    return type.name && type.name == boost::core::string_view("bignum");
}

inline bool tag_invoke(
        const equivalent_type_tag<bignum> & tag,
        const Tcl_ObjType & type)
{
    if (type.name)
