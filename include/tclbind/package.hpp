...
#ifndef TCLBIND_PACKAGE_HPP
#define TCLBIND_PACKAGE_HPP
...
#define TCLBIND_INIT_OO_STUBS() if (Tcl_OOInitStubs(interp) == nullptr) return TCL_ERROR;
#else
#define TCLBIND_INIT_OO_STUBS()
#endif

#define TCLBIND_PACKAGE(Package, Version, Name)                                  \
...
#undef TCLBIND_INIT_OO_STUBS

#endif //TCLBIND_PACKAGE_HPP
